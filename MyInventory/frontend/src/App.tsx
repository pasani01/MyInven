...
const STRINGS: Record<string, any> = {
  en: {
    ...
    search: "Search...",
    items: "Items",
    moneytypes: "Currencies",
    units: "Units",
    deleteUser: "Delete User",
    deleteConfirmText: (name: string) => `Are you sure you want to delete "${name}" ? ` ,
    deleteConfirmLabel: "Type the username to confirm:",
    deleteBtn: "Delete",
    addUser: "Add New User",
    loginTitle: "Welcome back",
    loginSub: "Sign in to RenoFlow",
    username: "Nickname",
    password: "Password",
    enterUsername: "Enter nickname",
    signIn: "Sign In →",
    signingIn: "Signing in...",
    totalWhs: "Total Warehouses",
    inventoryVal: "Inventory Value",
    lowStock: "Low Stock Items",
    recentShipments: "Recent Shipments",
    viewAll: "View All",
    whStats: "Warehouse Statistics",
    addBtn: "Add",
    editBtn: "Edit",
    filter: "Filter",
    all: "All",
    ...
    acrossAll: "Across all warehouses",
    view: "View",
    details: "Details",
    value: "Value",
    ...
    analytSec: "Analytics",
    mgmtSec: "Management",
    profileAcc: "Profile & Account",
    designColor: "Design and color settings",
    notifSettings: "Notifications",
    secPrivacy: "Security & Privacy",
    regionalSett: "Regional Settings",
    ...
    notifLowStockLabel: "Low Stock",
    notifLowStockDesc: "When quantity drops low",
    notifShipmentsLabel: "Shipments",
    notifShipmentsDesc: "When status changes",
    notifReportsLabel: "Reports",
    notifReportsDesc: "Weekly summary",
    changePassSub: "Update your password",
    confirmPass: "Confirm Password",
    changeBtn: "Change",
    langSub: "Choose interface language",
    dangerZoneSub: "These actions cannot be undone.",
    resetSettings: "Reset Settings",
    resetSettingsDesc: "Reset all settings to defaults?",
    deleteAccount: "Delete Account",
    deleteAccountDesc: "Permanently delete this account and all data?",
    settingsSub: "Account, appearance, and system settings",
    saveSuccess: "Saved successfully!",
    email: "Email",
  },
  uz: {
    warehouses: "Omborlar", analytics: "Tahlil", intake: "Aqlli Skan", settings: "Sozlamalar", users: "Foydalanuvchilar",
    darkMode: "Tungi rejim", lightMode: "Kunduzgi", logout: "Chiqish", createWh: "Ombor yaratish",
    save: "Saqlash", cancel: "Bekor qilish", search: "Qidirish...", items: "Mahsulotlar",
    moneytypes: "Valyutalar", units: "Birliklar", deleteUser: "O'chirish",
    deleteConfirmText: (name: string) => `"${name}" ni o'chirmoqchimisiz?`,
deleteConfirmLabel: "Tasdiqlash uchun foydalanuvchi nomini yozing:", deleteBtn: "O'chirish",
  addUser: "Yangi foydalanuvchi", loginTitle: "Xush kelibsiz", loginSub: "RenoFlow tizimiga kiring",
    username: "Nickname", password: "Parol", enterUsername: "Nickname kiriting", signIn: "Kirish →",
      signingIn: "Kirilmoqda...", totalWhs: "Jami omborlar", inventoryVal: "Inventar qiymati",
        lowStock: "Kam qolganlar", recentShipments: "So'nggi harakatlar", viewAll: "Hammasi",
          whStats: "Ombor statistikasi", addBtn: "Qo'shish", editBtn: "Tahrirlash", filter: "Saralash",
            all: "Hammasi", scanning: "Skanerlanmoqda...", detected: "Topilgan mahsulotlar",
              confirmAdd: "Tasdiqlash va qo'shish", profile: "Profil", appearance: "Ko'rinish", security: "Xavfsizlik",
                general: "Umumiy", language: "Til", accentColor: "Asosiy rang", compactMode: "Ixcham ko'rinish",
                  changePass: "Parolni o'zgartirish", currentPass: "Eski parol", newPass: "Yangi parol",
                    statusActive: "Faol", totalItems: "Jami Mahsulotlar", acrossAll: "Barcha omborlarda", view: "Ko'rish",
                      details: "Tafsilotlar", value: "Qiymat", itemsInStock: "Zaxirada", low: "kam",
                        addWhDesc: "Yangi ombor yarating.", mainSec: "Asosiy", refSec: "Ma'lumotnomalar", analytSec: "Tahlillar",
                          mgmtSec: "Boshqaruv", profileAcc: "Profil va Hisob", designColor: "Dizayn va rang sozlamalari",
                            notifSettings: "Bildirishnomalar", secPrivacy: "Xavfsizlik va Maxfiylik", regionalSett: "Mintaqaviy sozlamalar",
                              dangerZone: "Xavfli hudud", config: "Konfiguratsiya", qty: "Miqdor", price: "Narx",
                                currency: "Valyuta", unit: "Birlik", total: "Jami", date: "Sana", product: "Mahsulot",
                                  backBtn: "Orqaga", you: "Siz", noResults: "Foydalanuvchilar topilmadi",
                                    addUserPrompt: "Boshlash uchun yangi foydalanuvchi qo'shing.", newMessage: "Yangi xabar keldi!",
                                      profileSub: "Shaxsiy ma'lumotlaringizni boshqaring", darkModeDesc: "Tungi interfeys",
                                        compactModeDesc: "Kamroq joydan foydalanish", notifLowStockLabel: "Kam zaxira",
                                          notifLowStockDesc: "Mahsulot kam qolganda", notifShipmentsLabel: "Haraktlar",
                                            notifShipmentsDesc: "Status o'zgarganda", notifReportsLabel: "Hisobotlar",
                                              notifReportsDesc: "Haftalik xulosa", changePassSub: "Parolni yangilang",
                                                confirmPass: "Tasdiqlash", changeBtn: "O'zgartirish", langSub: "Interfeys tilini tanlang",
                                                  dangerZoneSub: "Ushbu harakatlarni bekor qilib bo'lmaydi.", resetSettings: "Sozlamalarni tiklash",
                                                    resetSettingsDesc: "Barcha sozlamalar boshlang'ich holatga qaytarilsinmi?",
                                                      deleteAccount: "Hisobni o'chirish", deleteAccountDesc: "Hisobingiz va barcha ma'lumotlar butunlay o'chirilsinmi?",
                                                        settingsSub: "Hisob, ko'rinish va tizim sozlamalari", saveSuccess: "Muvaffaqiyatli saqlandi!",
                                                          email: "Email",
  },
ru: {
  warehouses: "Склады", analytics: "Аналитика", intake: "Скан-приход", settings: "Настройки", users: "Пользователи",
    darkMode: "Темная тема", lightMode: "Светлая", logout: "Выйти", createWh: "Создать склад",
      save: "Сохранить", cancel: "Отмена", search: "Поиск...", items: "Товары", moneytypes: "Валюты",
        units: "Единицы", deleteUser: "Удалить", deleteConfirmText: (name: string) => `Удалить "${name}"?`,
              ...
              enterUsername: "Введите никнейм", signIn: "Войти →", signingIn: "Вход...",
                totalWhs: "Всего складов", inventoryVal: "Стоимость запасов", lowStock: "Мало товара",
                  recentShipments: "Последние поставки", viewAll: "Все", whStats: "Статистика склада",
                    addBtn: "Добавить", editBtn: "Изм.", filter: "Фильтр", all: "Все", scanning: "Сканирование...",
                      detected: "Найдено товаров", confirmAdd: "Подтвердить", profile: "Профиль", appearance: "Оформление",
                        security: "Безопасность", general: "Общие", language: "Язык", accentColor: "Основной цвет",
                          compactMode: "Компактный вид", changePass: "Сменить пароль", currentPass: "Старый пароль",
                            newPass: "Новый пароль", statusActive: "Активно", totalItems: "Всего товаров", acrossAll: "По всем складам",
                              view: "Смотреть", details: "Детали", value: "Цена", itemsInStock: "В наличии", low: "мало",
                                addWhDesc: "Создать новый склад.", mainSec: "Главное", refSec: "Справочники", analytSec: "Аналитика",
                                  mgmtSec: "Управление", profileAcc: "Профиль и Аккаунт", designColor: "Настройки дизайна",
                                    notifSettings: "Уведомления", secPrivacy: "Безопасность", regionalSett: "Региональные настройки",
                                      dangerZone: "Опасная зона", config: "Конфигурация", qty: "Кол-во", price: "Цена",
                                        currency: "Валюта", unit: "Ед.", total: "Итого", date: "Дата", product: "Товар",
                                          backBtn: "Назад", you: "Вы", noResults: "Не найдено", addUserPrompt: "Добавьте пользователя.",
                                            newMessage: "Новое сообщение!", profileSub: "Управление личной информацией",
                                              darkModeDesc: "Темный интерфейс", compactModeDesc: "Использовать меньше места",
                                                notifLowStockLabel: "Мало товара", notifLowStockDesc: "Когда количество товара падает",
                                                  notifShipmentsLabel: "Поставки", notifShipmentsDesc: "При изменении статуса",
                                                    notifReportsLabel: "Отчеты", notifReportsDesc: "Еженедельная сводка",
                                                      changePassSub: "Обновить пароль", confirmPass: "Подтверждение", changeBtn: "Изменить",
                                                        langSub: "Выберите язык интерфейса", dangerZoneSub: "Эти действия нельзя отменить.",
                                                          resetSettings: "Сброс настроек", resetSettingsDesc: "Сбросить все настройки по умолчанию?",
                                                            deleteAccount: "Удалить аккаунт", deleteAccountDesc: "Навсегда удалить этот аккаунт и все данные?",
                                                              settingsSub: "Настройки аккаунта, оформления и системы", saveSuccess: "Успешно сохранено!",
                                                                email: "Email",
  },
tr: {
      ...
      save: "Kaydet", cancel: "İptal", search: "Ara...", items: "Ürünler", moneytypes: "Para Birimleri",
        units: "Birimler", deleteUser: "Kullanıcıyı sil", deleteConfirmText: (name: string) => `"${name}" silinsin mi?`,
          deleteConfirmLabel: "Onay için kullanıcı adını girin:", deleteBtn: "Sil", addUser: "Yeni Kullanıcı",
            loginTitle: "Tekrar hoşgeldiniz", loginSub: "RenoFlow'a giriş yapın", username: "Kullanıcı Adı",
              password: "Şifre", enterUsername: "Kullanıcı adı girin", signIn: "Giriş Yap →",
                signingIn: "Giriş yapılıyor...", totalWhs: "Toplam Depo", inventoryVal: "Envanter Değeri",
                  lowStock: "Kritik Stok", recentShipments: "Son Hareketler", viewAll: "Tümü",
                    whStats: "Depo İstatistikleri", addBtn: "Ekle", editBtn: "Düzenle", filter: "Filtrele",
                      all: "Tümü", scanning: "Taranıyor...", detected: "Tespit Edilenler", confirmAdd: "Onayla ve Ekle",
                        profile: "Profil", appearance: "Görünüm", security: "Güvenlik", general: "Genel",
                          language: "Dil", accentColor: "Vurgu Rengi", compactMode: "Sıkışık Görünüm", changePass: "Şifre Değiştir",
                            currentPass: "Mevcut Şifre", newPass: "Yeni Şifre", statusActive: "Aktif", totalItems: "Toplam Ürün",
                              acrossAll: "Tüm depolarda", view: "Görüntüle", details: "Detaylar", value: "Değer",
                                itemsInStock: "Stokta", low: "az", addWhDesc: "Yeni depo oluşturun.", mainSec: "Ana Menü",
                                  refSec: "Referanslar", analytSec: "Analizler", mgmtSec: "Yönetim", profileAcc: "Profil ve Hesap",
                                    designColor: "Tasarım ayarları", notifSettings: "Bildirimler", secPrivacy: "Güvenlik ve Gizlilik",
                                      regionalSett: "Bölgesel Ayarlar", dangerZone: "Tehlikeli Bölge", config: "Konfigürasyon",
                                        qty: "Miktar", price: "Fiyat", currency: "Para Birimi", unit: "Birim", total: "Toplam",
                                          date: "Tarih", product: "Ürün", backBtn: "Geri", you: "Sen", noResults: "Bulunamadı",
                                            addUserPrompt: "Kullanıcı ekleyin.", newMessage: "Yeni mesaj!",
                                              profileSub: "Kişisel bilgilerinizi yönetin", darkModeDesc: "Karanlık arayüz",
                                                compactModeDesc: "Daha az alan kullan", notifLowStockLabel: "Kritik Stok",
                                                  notifLowStockDesc: "Miktar azaldığında", notifShipmentsLabel: "Sevkiyatlar",
                                                    notifShipmentsDesc: "Durum değiştiğinde", notifReportsLabel: "Raporlar",
                                                      notifReportsDesc: "Haftalık özet", changePassSub: "Şifrenizi güncelleyin",
                                                        confirmPass: "Onayla", changeBtn: "Değiştir", langSub: "Arayüz dilini seçin",
                                                          dangerZoneSub: "Bu işlemler geri alınamaz.", resetSettings: "Ayarları Sıfırla",
                                                            resetSettingsDesc: "Tüm ayarlar varsayılana sıfırlansın mı?",
                                                              deleteAccount: "Hesabı Sil", deleteAccountDesc: "Bu hesabı ve tüm verileri kalıcı olarak silinsin mi?",
                                                                settingsSub: "Hesap, görünüm ve sistem ayarları", saveSuccess: "Başarıyla kaydedildi!",
                                                                  email: "E-posta",
  },
detected: "Tespit Edilenler",
  confirmAdd: "Onayla ve Ekle",
    profile: "Profil",
      appearance: "Görünüm",
        security: "Güvenlik",
          general: "Genel",
                                        ...
                                        addWhDesc: "Yeni depo oluşturun.",
                                          mainSec: "Ana Menü",
                                            refSec: "Referanslar",
                                              analytSec: "Analizler",
                                                mgmtSec: "Yönetim",
                                                  profileAcc: "Profil ve Hesap",
                                                    designColor: "Tasarım ayarları",
                                                      notifSettings: "Bildirimler",
                                                        secPrivacy: "Güvenlik va Gizlilik",
                                                          regionalSett: "Mintaqaviy sozlamalar",
                                                                                  ...
                                                                                  noResults: "Bulunamadı",
                                                                                    addUserPrompt: "Kullanıcı ekleyin.",
                                                                                      newMessage: "Yeni mesaj!",
                                                                                        profileSub: "Kişisel bilgilerinizi yönetin",
                                                                                          darkModeDesc: "Karanlık arayüz",
                                                                                            compactModeDesc: "Daha az alan kullan",
                                                                                              notifLowStockLabel: "Kritik Stok",
                                                                                                notifLowStockDesc: "Miktar azaldığında",
                                                                                                  notifShipmentsLabel: "Sevkiyatlar",
                                                                                                    notifShipmentsDesc: "Durum değiştiğinde",
                                                                                                      notifReportsLabel: "Raporlar",
                                                                                                        notifReportsDesc: "Haftalık özet",
                                                                                                          changePassSub: "Şifrenizi güncelleyin",
                                                                                                            confirmPass: "Onayla",
                                                                                                              changeBtn: "Değiştir",
                                                                                                                langSub: "Arayüz dilini seçin",
                                                                                                                  dangerZoneSub: "Bu işlemler geri alınamaz.",
                                                                                                                    resetSettings: "Ayarları Sıfırla",
                                                                                                                      resetSettingsDesc: "Tüm ayarlar varsayılana sıfırlansın mı?",
                                                                                                                        deleteAccount: "Hesabı Sil",
                                                                                                                          deleteAccountDesc: "Bu hesabı ve tüm verileri kalıcı olarak silinsin mi?",
                                                                                                                            settingsSub: "Hesap, görünüm ve sistem ayarları",
